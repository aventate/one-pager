...
import { Clock, Check, X, Store, ShoppingBag, LayoutDashboard, Shield, Wrench, Sparkles, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <section id="section-05" className="py-12 sm:py-16 border-b border-border-subtle">
      <div className="w-full max-w-[1780px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 sm:mb-10 text-center max-w-5xl mx-auto">
          <div className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full bg-primary-subtle border border-primary-soft mb-4 shadow-xs">
          ...
          <p className="text-base sm:text-lg text-foreground-strong leading-relaxed font-normal mx-auto max-w-5xl">
        ...
        <div className="bg-white rounded-[28px] border border-border-subtle shadow-lg p-6 sm:p-10 w-full max-w-7xl mx-auto">
          ...
          <div className="p-5 sm:p-6 rounded-2xl bg-primary-subtle/40 border border-primary-soft flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
            ...
            <div className="flex items-center gap-2 text-xs sm:text-sm text-emerald-800 bg-emerald-50 px-4 py-2.5 rounded-xl border border-emerald-200 font-bold shrink-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-8">
            ...
            <div className="md:col-span-7 space-y-3.5">
              <div className="inline-flex items-center gap-2 text-xs font-black tracking-wider text-emerald-800 uppercase bg-emerald-50 px-3.5 py-1.5 rounded-lg border border-emerald-200 mb-1">
            ...
            <div className="md:col-span-5 space-y-3.5 md:border-l md:border-border-subtle md:pl-8">
              <div className="inline-flex items-center gap-2 text-xs font-black tracking-wider text-slate-700 uppercase bg-slate-100 px-3.5 py-1.5 rounded-lg border border-slate-200 mb-1">
